...
--
-- Indexes for table `streaminglog`
--
ALTER TABLE `streaminglog`
...
--
-- AUTO_INCREMENT for table `streaminglog`
--
ALTER TABLE `streaminglog`
...
--
ALTER TABLE `playlistsong`
  ADD CONSTRAINT `playlistsong_ibfk_1` FOREIGN KEY (`PlaylistID`) REFERENCES `playlist` (`PlaylistID`),
  ADD CONSTRAINT `playlistsong_ibfk_2` FOREIGN KEY (`SongID`) REFERENCES `song` (`SongID`);

--
-- Constraints for table `song`
--
ALTER TABLE `song`
  ADD CONSTRAINT `song_ibfk_1` FOREIGN KEY (`AlbumID`) REFERENCES `album` (`AlbumID`);

--
-- Constraints for table `streaminglog`
--
ALTER TABLE `streaminglog`
  ADD CONSTRAINT `streaminglog_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`),
  ADD CONSTRAINT `streaminglog_ibfk_2` FOREIGN KEY (`SongID`) REFERENCES `song` (`SongID`);
